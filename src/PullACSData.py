...
def ACS_PullGroup(table,data_name=None,state_FIPS='08'):
	...
	'''.format(table,state_FIPS)
	# pull_request='''
	# https://api.census.gov/data/2021/acs/acs5/profile?get=group({})&for=us:1
	# '''.format(table)
	# print(pull_request)
	pull_request="".join(line.strip() for line in pull_request.splitlines())
	# print(pull_request)
...
def PullData(state_FIPS='08'):
	...
	df_ho=df_in.rename(columns={'B25033_001E':'Total', 'B25033_002E':'Owned', 'B25033_003E':'1 Owned', 'B25033_004E':'2 to 4 Owned',
       'B25033_005E':'5+ Owned', 'B25033_006E':'Mobile Home Owned', 'B25033_007E':'Other Owned', 'B25033_008E':'Rented',
       'B25033_009E':'1 Rented', 'B25033_010E':'2 to 4 Rented', 'B25033_011E':'5+ Rented', 'B25033_012E':'Mobile Home Rented',
